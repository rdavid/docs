...
| 1.3 | September 1, 2026 | David Rabkin | Improved wording
| 1.4 | September 12, 2026 | David Rabkin | Improved wording
|===
...
The {url-catalog}[88 test cases], both mandatory and optional, span nine
suites.

== Operators

The certification team ran the {url-cnf-cert}[CNF Certification Test] on over
two hundred {url-operators}[Red Hat operators] on OCP {ocp-version}, finding an
average of thirty failures per operator.
...
Address the most common mandatory tests first.
See the frequencies tab in the report.
...
The certification team should distinguish platform-side taints, ideally
none, from taints the CNF under test introduces.
